...
public class GameCourt extends JPanel {
	...
	private User player1;          // the Black Square, keyboard control
	private Zombie snitch;          // the Golden Snitch, bounces
	...
	public void reset() {
		...
		player1 = new User(COURT_WIDTH, COURT_HEIGHT);
		//poison = new Poison(COURT_WIDTH, COURT_HEIGHT);
		snitch = new Zombie(COURT_WIDTH, COURT_HEIGHT);
	...
	void tick(){
		if (playing) {
			...
			if (bullet != null && bullet.intersects(snitch) ) {
				playing = false;
